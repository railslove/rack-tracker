...
class MetalController < ActionController::Metal
  ...
  def google_analytics
    tracker do |t|
      ...
      t.google_analytics :parameter, dimension1: "Some escaped \\'value"
      t.google_analytics :parameter, dimension2: "Author's name"
    end
    render 'metal/index'
  end
  ...
  def google_adwords_conversion
    tracker do |t|
      t.google_adwords_conversion :conversion, { id: 123_456, language: 'en', format: '3', color: 'ffffff', label: 'Conversion Label' }
    end
    render 'metal/index'
  end
  ...
  def criteo
    tracker do |t|
      ...
      t.criteo :view_list, { item: %w[P001 P002] }
